    ...
    return (
        <>
            <div className="w-full dark:bg-[#1C1D20] bg-[#999D9E] px-[4vw] lg:h-[6vw] md:h-[10vw] sm:h-[12vw] h-[24vw] text-white flex items-center justify-between">
                <Link to="/">
                    <div onMouseEnter={() => {
                        ...
                        setSpin(false)
                    }} ref={logoRef} className='cursor-pointer sm:w-[142px] w-[125px] overflow-hidden'>
                        <Magnetic points={0.5}>
                            <p ref={nameRef} className='sm:text-lg flex gap-1 whitespace-nowrap'>
                ...
                <div className='md:hidden flex items-center'>
                    ...
                    <div className='md:hidden block' onClick={() => {
                        ...
                        <Magnetic points={0.5}>
                            <p className='cursor-pointer sm:w-[10vw] h-[10vw] w-[15vw] rounded-full flex items-center justify-end sm:text-lg before:w-[1vw] before:h-[1vw] before:bg-white before:rounded-full gap-[1vw]'>
                                Menu
                            </p>
                        </Magnetic>
                    </div>
            ...
            <div className={`${scrollBtnToggle ? "scale-100" : "scale-0"} fixed sm:right-8 right-4 sm:top-8 top-4 z-[90]`} style={{ transition: "transform 0.6s cubic-bezier(0.34, 1.56, 0.64, 1)" }}>
                <Button className="sm:w-[5.5vw] w-[18vw] sm:h-[5.5vw] h-[18vw]">
                        ...
                        <Magnetic points={0.4}>
                            <p>
                                <label className="btn-circle swap swap-rotate">
                                    ...
                                    {/* hamburger icon */}
                                    <svg className="swap-off fill-current w-7 h-7" xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 512 512"><path d="M64,384H448V341.33H64Zm0-106.67H448V234.67H64ZM64,128v42.67H448V128Z" /></svg>
                                    {/* close icon */}
                                    <svg className="swap-on fill-current w-7 h-7" xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 512 512"><polygon points="400 145.49 366.51 112 256 222.51 145.49 112 112 145.49 222.51 256 112 366.51 145.49 400 256 289.49 366.51 400 400 366.51 289.49 256 400 145.49" /></svg>
                                </label>
                            </p>
                        </Magnetic>
                    </div>
